...
add_action('wp_enqueue_scripts', 'inpyside_resources');
...
add_action('after_setup_theme', 'inpyside_setup');
...
function inpyside_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'lwp_btn_hover_color_control', array(
		'label' => __('Button Hover Color', 'inpyside'),
		'section' => 'lwp_standard_colors',
...
add_action('customize_register', 'inpyside_customize_register');



// Output Customize CSS
function inpyside_customize_css() { ?>
...
add_action('wp_head', 'inpyside_customize_css');
